...
//		}
		int delta = MgrT.getInstance().getDip2Px(getContext(), 4);
		paint.setColor(Color.parseColor("#dba449"));
		paint.setStyle(Paint.Style.FILL);
		canvas.drawRect(centre - delta, centre - delta, centre + delta, centre + delta, paint);
