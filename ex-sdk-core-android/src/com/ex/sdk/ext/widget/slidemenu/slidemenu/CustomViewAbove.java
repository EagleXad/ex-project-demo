package com.ex.sdk.ext.widget.slidemenu.slidemenu;

import java.util.ArrayList;
import java.util.List;

import com.ex.sdk.ext.widget.slidemenu.slidemenu.SlidingMenu.OnClosedListener;
import com.ex.sdk.ext.widget.slidemenu.slidemenu.SlidingMenu.OnOpenedListener;
		...
		case MotionEvent.ACTION_MOVE:
			try {
				...
				if (activePointerId == INVALID_POINTER)
					break;
				final int pointerIndex = this.getPointerIndex(ev,
						activePointerId);
				...
				if (DEBUG)
					Log.v(TAG, "onInterceptTouch moved to:(" + x + ", " + y
							+ "), diff:(" + xDiff + ", " + yDiff
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_MOVE:
			if (!mIsBeingDragged) {
				...
				final float yDiff = Math.abs(y - mLastMotionY);
				if (DEBUG)
					Log.v(TAG, "onTouch moved to:(" + x + ", " + y
							+ "), diff:(" + xDiff + ", " + yDiff
