...
import com.ex.sdk.ext.widget.swipbacklayout.app.SwipeBackActivity;
...
public abstract class ExBaseSwipeBackAcvitiy extends SwipeBackActivity {
	...
	protected ExBaseSwipeBackAcvitiy mAcvitiy;
	...
	protected void startTask(String url, int what) {
		...
		startTask(url, what, ExBaseSwipeBackAcvitiy.LOADING_DIALOG_SHOW);
	}
	...
	private Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			int arg2 = msg.arg2;
			// 判断是否显示对话框
			if (arg1 == ExBaseSwipeBackAcvitiy.LOADING_DIALOG_SHOW) {
