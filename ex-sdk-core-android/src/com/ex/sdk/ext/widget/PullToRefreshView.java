...
public class PullToRefreshView extends LinearLayout {
	...
	private void addHeaderView() {
		// header view
		mHeaderView = mInflater.inflate(R.layout.ex_refresh_header, this, false);
	...
	private void addFooterView() {
		// footer view
		mFooterView = mInflater.inflate(R.layout.ex_refresh_footer, this, false);
	...
	private void footerPrepareToRefresh(int deltaY) {
		...
		if (Math.abs(newTopMargin) >= (mHeaderViewHeight + mFooterViewHeight)
			...
			mFooterTextView.setText(R.string.pull_to_refresh_release_label);
	...
	public void onHeaderRefreshComplete() {
		...
		mHeaderImageView.setImageResource(R.drawable.ex_ic_pulltorefresh_arrow);
		mHeaderTextView.setText(R.string.pull_to_refresh_pull_label);
...
//		mHeaderUpdateTextView.setText("");
	...
	public void onFooterRefreshComplete() {
		...
		mFooterImageView.setImageResource(R.drawable.ex_ic_pulltorefresh_arrow_up);
		mFooterTextView.setText(R.string.pull_to_refresh_footer_pull_label);
