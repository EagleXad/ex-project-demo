...
public class EditPage extends FakeActivity implements OnClickListener, TextWatcher {
	...
	private LinearLayout getAtLine(String platform) {
		if ("SinaWeibo".equals(platform) || "TencentWeibo".equals(platform) || "Facebook".equals(platform) || "Twitter".equals(platform)) {
			LinearLayout llAt = new LinearLayout(getContext());
			LinearLayout.LayoutParams lpAt = new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
			...
			tvName.setText(text);
			LinearLayout.LayoutParams lpName = new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
	...
	private LinearLayout getPlatformList() {
		...
		LinearLayout.LayoutParams lpTb = new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT);
		...
		LinearLayout.LayoutParams lpShareTo = new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
		...
		LinearLayout.LayoutParams lpSv = new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
